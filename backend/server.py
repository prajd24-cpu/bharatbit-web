...
async def get_bank_details():
    ...
    return {
        "bank_name": "HDFC Bank",
        "account_holder": "BharatBit OTC Desk Pvt Ltd",
...
async def get_upi_details():
    return {
        ...
        "qr_code": "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg=="  # Mock QR
    }
