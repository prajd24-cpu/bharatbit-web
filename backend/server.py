...
async def get_bank_details():
    ...
    return {
        "bank_name": "YOUR BANK NAME",  # e.g., "HDFC Bank", "ICICI Bank"
        "account_holder": "YOUR BUSINESS NAME",  # Legal name as per bank
        "account_number": "YOUR_ACCOUNT_NUMBER",  # Your actual account number
        "ifsc": "YOUR_IFSC_CODE",  # e.g., "HDFC0001234"
        "branch": "YOUR BRANCH NAME",  # e.g., "Mumbai Main Branch"
...
async def get_upi_details():
    ...
    return {
        "upi_id": "yourbusiness@bankname",  # Your actual UPI ID
